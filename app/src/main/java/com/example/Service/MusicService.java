...
import com.example.tikmusic.PlayMusicFragment;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener {
    ...
    List<MusicData> musicDatas = (List<MusicData>) intent.getSerializableExtra(PlayMusicFragment.PARAM_MUSIC_LIST);
     /*这意味着它的生命周期与 MainActivity 类本身相关，而不是与 MainActivity 的实例相关*/
